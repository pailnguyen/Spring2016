...
BLOG_AUTHOR = "Paul Nguyen"  # (translatable)
BLOG_TITLE = "Fundamentals of Python (Aptamer Stream)"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://pailnguyen.github.io/Spring2016/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://pailnguyen.github.io/Spring2016/"
BLOG_EMAIL = "paul_nguyen@utexas.edu"
BLOG_DESCRIPTION = "Fundamentals of Python (Aptamer Stream), Spring 2016."  # (translatable)
